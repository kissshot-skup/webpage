...
■モチベーション<br>
一言でいうと<br>
マイコン、組み込みOSなど下回りを意識したモノ作りができるようになりたいという気持ちがあり<br>
数多いるアプリ開発者とはひと味異なる、スパイシーなエンジニアに成る必要があると感じたため。<br>
なんだか面接みたい…笑。<br>
こんなこと自然には思いつかないと思うので、少しだけ背景を書かせてください<br>
<br>
<br>
...
具体的にはhome/*/ ←*はusername　以下で実行すれば問題がなくなった。
